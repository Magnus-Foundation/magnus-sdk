...
export const CROSS_FX_PSM_ADDRESS: Address =
  '0xfecc000000000000000000000000000000000000'

export const MAGNUS_BRIDGE_ADDRESS: Address =
  '0xb12d000000000000000000000000000000000000'
